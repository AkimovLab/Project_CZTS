...
# Lowest and highest orbital, Here HOMO is 248
params['lowest_orbital'] = 248-100
params['highest_orbital'] = 248+51
...
if params['is_periodic']:
    params['A_cell_vector'] = [10.8683996201, 0.0000000000, 0.0000000000]
    params['B_cell_vector'] = [0.0000000000, 10.8683996201, 0.0000000000]
    params['C_cell_vector'] = [0.0000000000, 0.0000000000, 10.8495998383]
...
params['trajectory_xyz_filename'] = ''/path/to/step1/CZTS-MD-pos-1.xyz'
